        ...
        <div class="wrapper">
              ...
              <!--Start Page Title-->
               ...
               <div class="row">
                   <div class="col-md-12">
                       <div class="white-box">  
                       <h2 class="header-title">修改</h2>

                         <form class="js-validation-bootstrap form-horizontal" action="${pageContext.request.contextPath}/quality/get?id=${quality.id}" method="post">
                             <div class="form-group">
                                 <label class="col-md-2 control-label">类型</label>
                                 <div class="col-md-10">
                                     <input class="form-control" name="type" value="${quality.type}" type="text">
                                 </div>
                             </div>
                             <div class="form-group">
                                 <label class="col-md-2 control-label">项目</label>
                                 <div class="col-md-10">
                                     <input class="form-control" name="project" value="${quality.project}" type="text">
                                 </div>
                             </div>
                             <div class="form-group">
                                 <label class="col-md-2 control-label">比重</label>
                                 <div class="col-md-10">
                                     <input class="form-control" name="proportion" value="${quality.proportion}" type="text">
                                 </div>
                             </div>
                             <div class="form-group">
                                 <label class="col-md-2 control-label">目标</label>
                                 <div class="col-md-10">
                                     <input class="form-control" name="target"  value="${quality.target}" type="text">
                                 </div>
                             </div>
