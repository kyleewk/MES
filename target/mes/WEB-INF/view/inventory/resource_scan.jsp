        ...
        <div class="row">
            <div class="col-md-12">
                <div class="white-box">
                    ...
                    <form class="js-validation-bootstrap form-horizontal" action="${pageContext.request.contextPath}/Resource/toscan" method="post">
                        <div class="form-group">
                            <label class="col-md-2 control-label">日志序列</label>
                            <div class="col-md-10">
                                <input class="form-control"  value="${}" type="text"  readonly="true">
                            </div>
                        </div>
