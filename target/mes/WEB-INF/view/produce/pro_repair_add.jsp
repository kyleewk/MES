               ...
               <div class="row">
                   <div class="col-md-12">
                       ...
                       <h2 class="header-title">返修记录</h2>
                           ...
                           <form class="js-validation-bootstrap form-horizontal" action="${pageContext.request.contextPath}/repair/add" method="post">                             <div class="form-group">
                               <label class="col-md-2 control-label">返修机种</label>
                               <div class="col-md-10">
                                   <input class="form-control" name="repairtype"   type="text">
                               </div>
                           </div>
                               <div class="form-group" style="margin-top: 50px" align="center">
                                   <label class="col-md-2 control-label">返修原因</label>
                                   <div class="col-md-10">
                                       <textarea class="form-control" name="modifyreason" rows="5"></textarea>
                                   </div>
                               </div>
                               <div class="form-group">
                                   ...
                                   <div class="col-md-10">
                                       <div class="input-group">
                                           <input type="text" class="form-control" name="modifydate"  placeholder="yyyy-MM-dd" id="datepicker-autoclose">
