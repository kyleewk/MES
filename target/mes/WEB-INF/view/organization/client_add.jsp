               ...
               <div class="row">
                   <div class="col-md-12">
                       ...
                       <h2 class="header-title">客户管理</h2>
                         ...
                         <form class="js-validation-bootstrap form-horizontal" action="${pageContext.request.contextPath}/client/add" method="post">
                             ...
                             <div class="form-group">
                                 ...
                                 <div class="col-md-10">
                                     <input class="form-control" name="customername" value="" type="text">
                                 </div>
                             </div>

                             <div class="form-group">
                                 <label class="col-md-2 control-label">客户地址</label>
                                 <div class="col-md-10">
                             ...
                             <div class="form-group">
                                 ...
                                 <div class="col-md-10">
                                     <input class="form-control" name="quantity" value="" type="text">
                                 </div>
                             </div>
                             ...
                             <div class="form-group">
                                 ...
                                 <div class="col-md-10">
                                     <div class="input-group">
                                         <input type="text" class="form-control" name="orderstartdate" placeholder="mm/dd/yyyy" id="datepicker-autoclose">
                             ...
                             <div class="form-group">
                                 <label class="control-label col-md-2">订单截止日期</label>
                                 <div class="col-md-10">
                                     <div class="input-group">
                                         <input type="text" class="form-control" name="orderstopdate" placeholder="mm/dd/yyyy" id="datepicker-autoclose1">
                                         <span class="input-group-addon b-0 text-white"><i class="icon-calender"></i></span>
                                     </div>
                                 </div>
                             </div>
                          <div class="form-group" style="margin-top: 50px" align="center">
                            <div class="col-md-8 col-md-offset-3">
                                <a class="btn  btn-primary"  href="${pageContext.request.contextPath}/client/list">返回</a>
