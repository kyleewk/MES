                   ...
                   <div class="col-md-12">
                       ...
                       <h2 class="header-title">班组管理</h2>
                         ...
                         <form class="js-validation-bootstrap form-horizontal" action="base_forms_validation.jsp" method="post">
                             ...
                             <div class="form-group">
                                 <label class="col-md-2 control-label" for="val-skill">生产部门<span class="text-danger">*</span></label>
                                 <div class="col-md-10">
                                     <select class="form-control" id="val-skill" name="val-skill">
                                         <option value="">请选择</option>
                                         <option value="demo1">生产一部</option>
                          ...
                          <div class="form-group" style="margin-top: 50px" align="center">
                            <div class="col-md-8 col-md-offset-3">
                                <a class="btn  btn-primary"  href="team_ann.jsp">返回</a>
                              <a class="btn  btn-primary"  href="team_ann.jsp">提交</a>
                            </div>
                          </div>
                        </form>
                       </div>
