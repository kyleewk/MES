...
<div class="main-content" >
    ...
    <div class="wrapper">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="white-box">
                    <h2 class="header-title">原料库</h2>

                    <<form class="js-validation-bootstrap form-horizontal" action="${pageContext.request.contextPath}/Resource/modify?id=${resource.id}" method="post">
                    <div class="form-group">
                        <label class="col-md-2 control-label">日志序列</label>
                        <div class="col-md-10">
                            <input class="form-control"  value="${resource.id}" type="text" readonly="true" >
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-10">
                            <input class="form-control"  value="${resource.num}" type="text" name="num" >
                        </div>
                    </div>
                        ...
                        <div class="form-item">
                            ...
                            <div class="col-md-10">
                                <div class="select-win" id="datesWrap1">
                                    ...
                                    <input type="text" placeholder="yyyy/MM/dd hh:mm:ss" id="date1" name="time" class="select-text" value="${resource.time}"/>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-10">
                            <select class="form-control" id="val-skill" name="response">
                                <option value="">${resource.response}</option>
