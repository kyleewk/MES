                ...
                <div class="white-box">
                    ...
                    <form class="js-validation-bootstrap form-horizontal" action="" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-10">
                                <input class="form-control"  value="${invBack.num}" type="number"  readonly="true">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-10">
                                <input class="form-control"  value="${invBack.type}" type="text" readonly="true">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-10">
                                <input class="form-control" value="${invBack.team}" type="text"  readonly="true">
                            </div>
                        </div>

                        <div class="form-group">
                            <label class="col-md-2 control-label">退料时间</label>
                            <div class="col-md-10">
                                <input class="form-control"  value="${invBack.time}" type="text"  readonly="true">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-10">
                                <input class="form-control" value="${invBack.reason}" type="text"  readonly="true">
                            </div>
                        </div>

                        <div class="form-group">
                            <label class="col-md-2 control-label">退料处理</label>
                            <div class="col-md-10">
                                <input class="form-control" value="${invBack.response}" type="text"  readonly="true">
                            </div>
                        </div>
