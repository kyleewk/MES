...
<div class="main-content" >
    ...
    <div class="wrapper">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="white-box">
                    <h2 class="header-title">领料日志</h2>

                    <form class="js-validation-bootstrap form-horizontal" action="${pageContext.request.contextPath}/InvGet/add" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-10">
                                <input class="form-control" name="leader" value="" type="text">
                            </div>
                        </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-10">
                                    <input class="form-control" name="team" value="" type="text">
                                </div>
                            </div>
                        ...
                        <div class="form-group">
                            <label class="col-md-2 control-label" for="val-skill" style="text-align: right">领料处理<span class="text-danger">*</span></label>
                            <div class="col-md-10">
