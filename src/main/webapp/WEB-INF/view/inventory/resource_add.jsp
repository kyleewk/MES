        ...
        <div class="row">
            <div class="col-md-12">
                <div class="white-box">
                    ...
                    <form class="js-validation-bootstrap form-horizontal" action="${pageContext.request.contextPath}/Resource/add" method="post">
                        ...
                        <div class="form-group">
                            <div class="form-item">
                                <div class="col-md-2 control-label">记录时间</div>
                                <div class="col-md-10">
                        ...
                        <div class="form-group">
                            <label class="col-md-2 control-label" for="val-skill" style="text-align: right">是否已审核<span class="text-danger">*</span></label>
                            <div class="col-md-10">
                        ...
                        <div class="form-group" style="margin-top: 50px" align="center">
                            <div class="col-md-8 col-md-offset-3">
                                <a class="btn  btn-primary"  href="${pageContext.request.contextPath}/Resource/list">返回</a>
