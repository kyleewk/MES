        ...
        <div class="row">
            <div class="col-md-12">
                <div class="white-box">
                    ...
                    <<form class="js-validation-bootstrap form-horizontal" action="${pageContext.request.contextPath}/InvGet/modify?id=${invGet.id}" method="post">
                    <div class="form-group">
                        <label class="col-md-2 control-label">日志序列</label>
                        <div class="col-md-10">
                            <input class="form-control" readonly="true" value="${invGet.id}" type="text" oninput="value=value.replace(/[^\d]/g,'')" >
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-10">
                            <input class="form-control" name="num" value="${invGet.num}" type="text" oninput="value=value.replace(/[^\d]/g,'')" >
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-10">
                            <input class="form-control" name="type" value="${invGet.type}" type="text" >
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-10">
                            <input class="form-control" name="leader" value="${invGet.leader}" type="text" >
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-10">
                            <input class="form-control" name="team" value="${invGet.team}" type="text"  >
                        </div>
                    </div>

                    <div class="form-group">
                        <div class="form-item">
                            <div class="col-md-2 control-label">领料时间</div>
                            <div class="col-md-10">
                                <div class="select-win" id="datesWrap1">
                                    <div class="select-btn" >
                                        <span class="select-btn-icon new-icon-calendar" id="dateBtn1"></span>
                                    </div>
                                    <input type="text" placeholder="yyyy/MM/dd hh:mm:ss" name="time" id="date1" class="select-text"/>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <label class="col-md-2 control-label" for="val-skill">领料处理<span class="text-danger">*</span></label>
                        <div class="col-md-10">
                            <select class="form-control" id="val-skill" name="response" >
                                <option value=""> ${invGet.response}</option>
