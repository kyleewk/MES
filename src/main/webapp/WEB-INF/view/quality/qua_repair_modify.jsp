               ...
               <div class="row">
                   <div class="col-md-12">
                       ...
                       <h2 class="header-title">异常记录</h2>
                           ...
                           <form class="js-validation-bootstrap form-horizontal" action="${pageContext.request.contextPath}/qualitylog/get?id=${quality.id}" method="post">
                               <div class="form-group">
                                   <label class="col-md-2 control-label">工单序号</label>
                                   <div class="col-md-10">
                                       <input class="form-control" name="${quality.orderid}"  type="text" readonly>
                                   </div>
                               </div>
                               <div class="form-group" style="margin-top: 50px" align="center">
                                   <label class="col-md-2 control-label">异常原因</label>
                                   <div class="col-md-10">
                                       <textarea class="form-control" name="reason" rows="5">${quality.reason}</textarea>
                                   </div>
                               </div>
                               <div class="form-group" style="margin-top: 50px" align="center">
                                   <label class="col-md-2 control-label">处理记录</label>
                                   <div class="col-md-10">
                                       <textarea class="form-control" name="result" rows="5">${quality.result}</textarea>
                                   </div>
                               </div>
                               <%--<div class="form-group">
                                   <label class="col-md-2 control-label">是否返修</label>
                                   <div class="col-md-10">
                                       <input class="form-control" name="${quality.isrepair}" checked="${quality.isrepair} == 1 ? 'checked' : '' " type="radio" value="1">是
                                       <input class="form-control" name="${quality.isrepair}" checked="${quality.isrepair} == 0 ? 'checked' : '' "  type="radio" value="0">否
                                   </div>
                               </div>--%>
                               <div class="form-group">
                                   <label class="col-md-2 control-label" >是否返修</label>
                                   <div class="col-md-10">
                                       <div class="radio">
                                           <input type="radio" name="isrepair" value="${quality.isrepair}" checked="${quality.isrepair} == 1 ? 'checked' : '' ">
                                           <label >是</label>
                                           &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                           <input type="radio" name="isrepair" value="${quality.isrepair}" checked="${quality.isrepair} == 0 ? 'checked' : '' ">
                                           <label >否</label>
                                       </div>
                                   </div>
                               </div>
