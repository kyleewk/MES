               ...
               <div class="row">
                   <div class="col-md-12">
                       ...
                       <h2 class="header-title">异常记录</h2>
                         ...
                         <form class="js-validation-bootstrap form-horizontal" action="${pageContext.request.contextPath}/qualitylog/add?id=${quality.id}" method="post">
                             ...
                             <div class="form-group">
                                 ...
                                 <div class="col-md-10">
                                     <div class="radio">
                                         <input type="radio" name="isrepair" value="${quality.isrepair}">
                                         <label >是</label>
                                         &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                         <input type="radio" name="isrepair" value="${quality.isrepair}" checked>
                                         <label >否</label>
                                     </div>
                                 </div>
                             </div>
