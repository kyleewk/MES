               ...
               <div class="row">
                   <div class="col-md-12">
                       ...
                       <h2 class="header-title">用户管理</h2>
                         ...
                         <form class="js-validation-bootstrap form-horizontal" action="${pageContext.request.contextPath}/employee/add" method="post">
                             ...
                             <div class="form-group">
                                 ...
                                 <div class="col-md-10">
                                     <input class="form-control" name="departmentId" value="" type="text">
                                 </div>
                             </div>
                             ...
                             <div class="form-group">
                                 ...
                                 <div class="col-md-10">
                                     <input class="form-control" name="positionId" value="" type="text">
                                 </div>
                             </div>
                             <div class="form-group">
                          ...
                          <div class="form-group" style="margin-top: 50px" align="center">
                            <div class="col-md-8 col-md-offset-3">
                                <a class="btn  btn-primary"  href="${pageContext.request.contextPath}/employee/list">返回</a>
