               ...
               <div class="row">
                   <div class="col-md-12">
                       ...
                       <h2 class="header-title">班组管理</h2>
                         ...
                         <form class="js-validation-bootstrap form-horizontal" action="${pageContext.request.contextPath}/team/add" method="post">

                             <div class="form-group">
                                 <label class="col-md-2 control-label">班组编号</label>
                                 <div class="col-md-10">
                             ...
                             <div class="form-group">
                                 ...
                                 <div class="col-md-10">
                                     <input class="form-control" name="productdepartment" value="" type="text">
                                 </div>
                             </div>
                             ...
                             <div class="form-group">
                                 <label class="col-md-2 control-label">生产班组</label>
                                 <div class="col-md-10">
                                     <input class="form-control" name="productteam" value="" type="text">
                                 </div>
                             </div>
                             <div class="form-group">
                                 <label class="col-md-2 control-label">班组人数</label>
                                 <div class="col-md-10">
                                     <input class="form-control" name="teamtotal" value="" type="text">
                                 </div>
                             </div>
                             <div class="form-group">
                                 <label class="col-md-2 control-label">计划完成产量</label>
                                 <div class="col-md-10">
                                     <input class="form-control" name="completetotalplan" value="" type="text">
                                 </div>
                             </div>
                             <div class="form-group">
                                 ...
                                 <div class="col-md-10">
                                     <div class="input-group">
                                         <input type="text" class="form-control" name="completetime" placeholder="mm/dd/yyyy" id="datepicker-autoclose">
                          ...
                          <div class="form-group" style="margin-top: 50px" align="center">
                            <div class="col-md-8 col-md-offset-3">
                                <a class="btn  btn-primary"  href="${pageContext.request.contextPath}/team/list">返回</a>
