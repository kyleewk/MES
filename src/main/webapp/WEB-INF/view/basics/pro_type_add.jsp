        ...
        <div class="wrapper">
              ...
              <!--Start Page Title-->
               ...
               <div class="row">
                   <div class="col-md-12">
                       <div class="white-box">  
                       <h2 class="header-title">产品类型</h2>

                         <form class="js-validation-bootstrap form-horizontal" action="${pageContext.request.contextPath}/product/add" method="post">
                             ...
                             <div class="form-group">
                                 ...
                                 <div class="col-md-10">
                                     <input class="form-control" name="unit" value="" type="text">
                                 </div>
                             </div>
