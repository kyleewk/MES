...
<body class="sticky-header body1">
                       ...
                       <h2 class="header-title">生产工单</h2>
                           <form class="js-validation-bootstrap form-horizontal" id="checkForm" action="${pageContext.request.contextPath}/orderCheck/check" method="post">
                             <div class="form-group">
                                 ...
                                 <div class="col-md-10">
                                     <input class="form-control" readonly="" name="orderid" value="${order.id}" type="text">
                                 </div>
                             </div>
                             ...
                             <div class="form-group">
                                 ...
                                 <div class="col-md-10">
                                     <input class="form-control" readonly="" value="${order.leader}" type="text">
                                 </div>
                             </div>
                             <div class="form-group">
                             ...
                             <div class="form-group">
                                 ...
                                 <div class="col-md-10">
                                     <input class="form-control" readonly="" value="${order.nextid}" type="text">
                                 </div>
                             </div>
                             <div class="form-group">
                           ...
                           <table id="example" class="display table">
                               ...
                               <input type="hidden" value="${emp.sn}" name="checksn">
                              ...
                              <div class="col-md-8 col-md-offset-3">
                                  <a class="btn  btn-primary" onclick="submitCheck('同意');">同意</a>
                                  <a class="btn  btn-primary" onclick="submitCheck('驳回');">驳回</a>
                                  <a class="btn  btn-primary" onclick="submitCheck('拒绝');">拒绝</a>
                              </div>
                        </form>
                       </div>
                    </div>
    ...
    <script src="${pageContext.request.contextPath}/statices/js/order/check.js"></script>
    <!-- BEGIN PAGE LEVEL SCRIPTS -->
