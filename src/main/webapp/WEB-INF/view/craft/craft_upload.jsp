...
<head>
  ...
  <title></title>
    ...
    <link href="${pageContext.request.contextPath}/statices/plugins/dropzone/dropzone.css" rel="stylesheet" type="text/css" />
...
<body class="sticky-header body1">
    ...
    <!-- BEGIN PAGE LEVEL SCRIPTS -->
	 <script src="${pageContext.request.contextPath}/statices/plugins/dropzone/dropzone.js"></script>
    <!-- BEGIN PAGE LEVEL SCRIPTS -->
