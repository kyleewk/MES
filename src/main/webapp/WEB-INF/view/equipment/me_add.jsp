               ...
               <div class="row">
                   <div class="col-md-12">
                       ...
                       <h2 class="header-title">设备信息</h2>
                         ...
                         <form class="js-validation-bootstrap form-horizontal" action="${pageContext.request.contextPath}/equipment/add" method="post">
                             ...
                             <div class="form-group">
                                 ...
                                 <div class="col-md-10">
                                     <input class="form-control" name="unittype" value="" type="text">
                                 </div>
                             </div>
                             <div class="form-group">
                                 <label class="col-md-2 control-label">设备用途</label>
                                 <div class="col-md-10">
                                     <input class="form-control" name="equipmentuse"  value="" type="text">
                                 </div>
                             </div>
                             <div class="form-group">
                             ...
                             <div class="form-group">
                                 ...
                                 <div class="col-md-10">
                                     <input class="form-control" name="factorynumber" value="" type="text">
                                 </div>
                             </div>
                             <div class="form-group">
                                 <label class="control-label col-md-2">接受日期</label>
                                 <div class="col-md-10">
                                     <div class="input-group">
                                         <input type="text" class="form-control" name="acceptancedate" placeholder="mm/dd/yyyy" id="datepicker-autoclose">
                                         <span class="input-group-addon b-0 text-white"><i class="icon-calender"></i></span>
                                     </div>
                                 </div>
                             </div>
                             <div class="form-group">
                                 <label class="control-label col-md-2">启用日期</label>
                                 <div class="col-md-10">
                                     <div class="input-group">
                                         <input type="text" class="form-control" name="commissioningdate" placeholder="mm/dd/yyyy" id="datepicker-autoclose1">
                                         <span class="input-group-addon b-0 text-white"><i class="icon-calender"></i></span>
                                     </div>
                                 </div>
                             </div>
                             <div class="form-group">
                                 ...
                                 <div class="col-md-10">
                                     <select class="form-control" id="val-skill" name="place">
                                         <option value="0">请选择</option>
                                         <option value="1">生产一部</option>
                                         <option value="2">生产二部</option>
                                         <option value="3">生产三部</option>
                                         <option value="4">生产四部</option>
                                         <option value="5">生产五部</option>
                                     </select>
                                 </div>
                             </div>
                             <div class="form-group">
                             ...
                             <div class="form-group">
                                 ...
                                 <div class="col-md-10">
                                     <input class="form-control" name="storeman"  value="" type="text">
                                 </div>
                             </div>
                          <div class="form-group" style="margin-top: 50px" align="center">
                            <div class="col-md-8 col-md-offset-3">
                                <a class="btn  btn-primary"  href="${pageContext.request.contextPath}/equipment/list">返回</a>
