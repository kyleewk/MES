               ...
               <div class="row">
                   <div class="col-md-12">
                       ...
                       <h2 class="header-title">维护信息</h2>
                         ...
                         <form class="js-validation-bootstrap form-horizontal" action="${pageContext.request.contextPath}/maintain/add" method="post">
                             <div class="form-group">
                                 <label class="col-md-2 control-label">维护序号</label>
                                 <div class="col-md-10">
                             ...
                             <div class="form-group">
                                 ...
                                 <div class="col-md-10">
                                     <input class="form-control" name="specification" value="" type="text">
                                 </div>
                             </div>
                             <div class="form-group">
                                 <label class="col-md-2 control-label">故障现象</label>
                                 <div class="col-md-10">
                                     <input class="form-control" name="fault" value="" type="text">
                                 </div>
                             </div>
                             <div class="form-group">
                                 <label class="col-md-2 control-label">维修人员</label>
                                 <div class="col-md-10">
                                     <input class="form-control" name="maintainer" value="" type="text">
                                 </div>
                             </div>
                             <div class="form-group">
                                 <label class="control-label col-md-2">维修日期</label>
                                 <div class="col-md-10">
                                     <div class="input-group">
                                         <input type="text" class="form-control" name="maintanencedate" placeholder="mm/dd/yyyy" id="datepicker-autoclose">
                             ...
                             <div class="form-group" style="margin-top: 50px" align="center">
                                 <div class="form-group">
                                     <label class="col-md-2 control-label">维修保养内容</label>
                                     <div class="col-md-10">
                                         <textarea name="maintanence" class="form-control" rows="5"></textarea>
                                     </div>
                                 </div>
                                 <div class="col-md-8 col-md-offset-3">
                                     <a class="btn  btn-primary"  href="${pageContext.request.contextPath}/maintain/list">返回</a>
