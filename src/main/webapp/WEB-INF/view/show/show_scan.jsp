                ...
                <div class="white-box">
                    ...
                    <form class="js-validation-bootstrap form-horizontal" action="base_forms_validation.jsp" method="post">
                        <div class="form-group">
                            ...
                            <div class="col-md-10">
                                <input class="form-control"  value="2020-01-01" type="date" readonly="true">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-10">
                                <input class="form-control"  value="111" type="text" oninput="value=value.replace(/[^\d]/g,'')" readonly="true">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-10">
                                <input class="form-control"  value="A1" type="text" readonly="true">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-10">
                                <input class="form-control" value="1111" type="text" oninput="value=value.replace(/[^\d]/g,'')" readonly="true">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-10">
                                <input class="form-control"  value="11" type="text" oninput="value=value.replace(/[^\d]/g,'')" readonly="true">
                            </div>
                        </div>
